...
public class V5_Flow extends Flow {
    ...
    public void save_raw(long SysUptime, long unix_secs, long unix_nsecs,
    	...
    	// writeFile.write("v5",RouterIP, srcaddr, dstaddr,nexthop,dPkts,dOctets,src_mask, dst_mask,(int)output, Last-First);
    	writeFile.write("v5",RouterIP, srcaddr, dstaddr,nexthop,dPkts,dOctets,src_mask, dst_mask,(int)output);
        /* try {
    ...
    public void save_raw4v9(long SysUptime, long unix_secs,
        ...
        System.out.println("Will writeFile.write");
    	writeFile.write("v9",RouterIP, srcaddr, dstaddr,nexthop,dPkts,dOctets,src_mask, dst_mask,(int)output);
